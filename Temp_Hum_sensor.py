...
class psuedoSensor:
    ...
    def __init__(self):
        self.temVal= self.t_range[self.t_range_index]
        self.humVal= self.h_range[self.h_range_index]

    def genrate_value(self):
        self.humVal = self.h_range[self.h_range_index] + random.uniform(0,10)
        self.temVal = self.t_range[self.t_range_index] + random.uniform(0,10)
        ...
        return self.humVal, self.temVal